                                ...
                                <form class="user" action="<?= route_to('login') ?>" method="post">
                                    ...
                                    <?php if ($config->validFields === ['email']) : ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.email') ?>" id=" exampleInputEmail" aria-describedby="emailHelp">
                                        </div>
                                    ...
                                    <?php else : ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.emailOrUsername') ?>" id=" exampleInputEmail" aria-describedby="emailHelp">
                                        </div>
                                        <div class="invalid-feedback">
                                            <?= session('errors.login') ?>
                                        </div>
