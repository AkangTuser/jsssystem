                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user <?php if (session('errors.employee_id')) : ?>is-invalid<?php endif ?>" name="employee_id" placeholder="<?= lang('Employee ID') ?>" value="<?= old('employee_id') ?>">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user <?php if (session('errors.full_name')) : ?>is-invalid<?php endif ?>" name="full_name" placeholder="<?= lang('Full Name') ?>" value="<?= old('full_name') ?>">
                                    </div>
