    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalformeditLabel">Edit Jabatan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('jabatan/update', ['class' => 'formsimpan']) ?>
            <input type="hidden" name="idjabatan" value="<?= $idjabatan; ?>">
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Nama Jabatan</label>
                    <input type="text" name="namajabatan" id="namajabatan" class="form-control form-control-sm" required value="<?= $namajabatan; ?>">
                </div>
            </div>
